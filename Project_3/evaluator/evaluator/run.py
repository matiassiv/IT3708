...
optimalFolder = path + "\\test_optimal"  # you may have to specify the complete path
studentFolder = path + "\\test_student" # you may have to specify the complete path
...
#			print("PRI 2: %.2f" % result2)
		...
		a = highestScore*100
		print(str(i)+" - Score: %.2f" % a + "%")
	a = totalScore/len(studentFiles)*100
	print("Total Average Score: %.2f" % a + "%")
	print(max_i, "Has Maximal Score:  %.2f" % max_score*100 + "%")
